...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="stylesheet-mit.css?v=<?php echo time(); ?>">
...
<body style="font-family: minecraft; height: 100%; line-height: 1.6">
  ...
  <!-- Declare Navbar. (Contains MIT Derived Code - TODO: Add LICENSE) -->
  ...
  <div class="w3-container">
    <span class="background-wrapper" style="padding: 32px 32px">
    ...
    <div class="w3-center" style="margin-top: 96px">
      ...
      <mark class="main-text"> &nbsp;<span class="bukkit-green"> The Open Source,</span>&nbsp;<br>&nbsp;<span class="bukkit-red"> Community-First,&nbsp;</span><br><span class="bukkit-dark-purple">&nbsp; <span class="bukkit-dark-red"><u>OG</u></span> Minecraft Experience! </span>&nbsp;
          <br><br><br>
          <p><a class="w3-button glow" style="text-decoration: none" href="#popup1">&nbsp; <span class="bukkit-blue"><strong>Join Server</strong></span> &nbsp;</a>
          <div id="popup1" class="overlay">
              <div class="popup">
                  <span style="text-align: left">
                      <span style="padding-top: 50px">How To Join <span class="bukkit-darkgreen">True</span><span class="red">OG</span>:</span>
                      <a class="close" href="#">&times;</a>
                      <p class="bukkit-red" id="disclaimer">
                      <i>Disclaimer: Joining <span class="bukkit-darkgreen">True</span><span class="red">OG</span> requires a valid Minecraft Java account. You should only purchase one from the <a href="https://minecraft.net/" class="bukkit-blue"><u>Official Website</u></a>. Using third party account-selling services violates the Mojang Terms of Service.</i>
                      </p>
                  </span>
              </div>
          </div>
  ...
  <div class="w3-container" style="padding: 32px 32px" id="features">
    <p class="w3-center" style="font-size: 6vh"><strong>What makes<span class="bukkit-darkgreen">&nbsp;True</span><span class="bukkit-dark-red">OG</span> Special?</strong></p>
  ...
  <div class="w3-container w3-deep-purple" style="padding: 32px 32px" id="rules">
    ...
    <div class="w3-row-padding" style="font-size: 3.5vh">
      ...
      <div class="w3-col m6 w3-center">
          <p style="font-size: 6vh"><strong>Discord:</strong></p>
          <iframe src="https://discordapp.com/widget?id=897286901101383680&theme=dark" width="400" height="500" frameBorder="0"></iframe>
      </div>
    </div>
  </div>
      ...
      <div class="w3-col l3 m6 w3-margin-bottom">
        <div class="w3-card">
          ...
          <div class="w3-container">
				...
				<p style="font-size: 3vh" class="reduce-line-height w3-center discord-blue"><a rel="me" href="https://union.place/@NotAlexNoyle">Mastodon</a></p>
          </div>
        </div>
      </div>
      <div class="w3-col l3 m6 w3-margin-bottom">
